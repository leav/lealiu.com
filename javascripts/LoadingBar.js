...
LoadingBar.prototype.initialize = function(total) {
	...
	var text = new createjs.Text('Loading', '4em Calibri', bar.strokeColor);
	this.addChild(text);
	text.regX = text.getMeasuredWidth() * 0.8;
	...
	this.doLayout = function() {
		...
		text.scaleX = text.scaleY = bar.scaleX = bar.scaleY = getWindowHeight() / bar.height * 0.10;
	}
